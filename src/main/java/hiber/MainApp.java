...
public class MainApp {
   public static void main(String[] args) throws SQLException {
      ...
      userService.add(new Car("BMW-X6", 891));
      userService.add(new Car("Mercedes c-class", 111));
      userService.add(new Car("Lexus", 777));
      userService.add(new Car("Toyota", 88));
      ...
      User findedUser = userService.findUser("Mercedes c-class", 111);
